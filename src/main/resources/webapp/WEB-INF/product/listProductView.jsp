...
<header data-bs-theme="dark">
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="/webapp" class="navbar-brand d-flex align-items-center">
...
<main>
  ...
  <ul>
		        <a href="/WEB-INF/product/listProduct?currentPage=1&menu=${menu}&searchCondition=${search.searchCondition}&searchKeyword=${search.searchKeyword}&orderBy=priceDesc">가격높은순</a>
		        <a href="/WEB-INF/product/listProduct?currentPage=1&menu=${menu}&searchCondition=${search.searchCondition}&searchKeyword=${search.searchKeyword}&orderBy=priceAsce">가격낮은순</a>
		        <a href="/WEB-INF/product/listProduct?currentPage=1&menu=${menu}&searchCondition=${search.searchCondition}&searchKeyword=${search.searchKeyword}&orderBy=viewsDesc">가장많이본상품</a>
		        <a href="/WEB-INF/product/listProduct?currentPage=1&menu=${menu}&searchCondition=${search.searchCondition}&searchKeyword=${search.searchKeyword}&orderBy=nameAsce">이름순</a>
	    	</ul>
...
<footer class="text-body-secondary py-5">
  <div class="container">
    ...
    <p class="mb-0">New to Bootstrap? <a href="/webapp">Visit the homepage</a> or read our <a href="/docs/5.3/getting-started/introduction/">getting started guide</a>.</p>
  </div>
</footer>
